...
def test_count_vector_featurizer(
    ...
    create_whitespace_tokenizer().process([train_message])
    create_whitespace_tokenizer().process([test_message])
...
def test_count_vector_featurizer_persist_load(
    ...
    create_whitespace_tokenizer().process([train_message1])
    create_whitespace_tokenizer().process([train_message2])
    ...
    create_whitespace_tokenizer().process([test_message1])
    test_ftr.process([test_message1])
    test_message2 = Message(data={TEXT: sentence2})
    create_whitespace_tokenizer().process([test_message2])
...
def test_count_vectors_featurizer_train(
    ...
    create_whitespace_tokenizer().process_training_data(TrainingData([message]))
...
def test_count_vector_featurizer_use_lemma(
    ...
    create_spacy_tokenizer().process([train_message])
    create_spacy_tokenizer().process([test_message])
